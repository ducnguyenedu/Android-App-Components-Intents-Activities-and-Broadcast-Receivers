...
import vandy.mooc.aad2.framework.application.adapters.BaseAdapter;
import vandy.mooc.aad2.framework.application.adapters.UriAdapter;
import vandy.mooc.aad2.framework.application.fragments.PagedFragment;
import vandy.mooc.aad2.framework.application.fragments.RecyclerViewFragment;
import vandy.mooc.aad2.framework.application.views.InputPanelView;
...
public abstract class MainActivityBase
    ...
    private void initializeViews() {
        ...
        assert mAddFab != null;
        mAddFab.setOnClickListener(view -> showInputPanel(!mInputPanel.isPanelShown()));
        ...
        mDownloadFab.setOnClickListener(view -> onDownloadClicked());
    }
    ...
    private void restoreStateFromPreferences() {
        ...
        final Set<String> stringSet =
                preferences.getStringSet(KEY_INPUT_URLS, new HashSet<>());
