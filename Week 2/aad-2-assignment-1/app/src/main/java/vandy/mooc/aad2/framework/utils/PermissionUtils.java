...
import vandy.mooc.aad2.assignment.BuildConfig;
...
public final class PermissionUtils {
    ...
    /**
     * Check that all given permissions have been granted by verifying that
     * each entry in the
    ...
    /**
     * Requests the external storage read/write permission.
